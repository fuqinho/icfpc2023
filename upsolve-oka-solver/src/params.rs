...
pub struct Params {
    pub placed_musicians_ratio: f64,    // 0.2 - 0.5
    pub important_attendees_ratio: f64, // 0.1 - 0.2
    pub important_musician_range: f64,  // 200 - 500
    ...
    pub forbidden_area_coeff: f64, // 0.4 - 1.0

    pub hungarian_rarity: usize, // 1_000_000 - 100_000_000

    pub swap: usize,        // 1 - 10
    pub move_random: usize, // 1 - 10
    pub move_dir: usize,    // 1 - 10
}
